...
export default function IntentSigner() {
  ...
  return (
    ...
    <Card className="relative overflow-hidden border-[var(--border)] bg-[var(--bg-card)]">
      ...
      <CardHeader className="relative z-10 px-6 pb-5 pt-2 sm:px-6">
      ...
      <CardContent className="relative z-10 space-y-7 px-6 py-7 sm:px-6">
        {/* Intent text */}
      ...
      <CardFooter className="relative z-10 justify-between border-t border-[var(--border)] bg-[var(--bg-card-2)]/40 px-6 py-3.5 sm:px-6">
