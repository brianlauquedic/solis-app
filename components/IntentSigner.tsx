...
export default function IntentSigner() {
  ...
  return (
    ...
    <Card className="relative overflow-hidden border-[var(--border)] bg-[var(--bg-card)]">
      ...
      <CardHeader className="relative z-10 px-8 pb-5 pt-4 sm:px-12 sm:pt-5">
      ...
      <CardContent className="relative z-10 space-y-7 px-8 py-7 sm:px-12 sm:py-8">
        {/* Intent text */}
      ...
      <CardFooter className="relative z-10 justify-between border-t border-[var(--border)] bg-[var(--bg-card-2)]/40 px-8 py-4 sm:px-12">
