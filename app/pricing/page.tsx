  ...
  return [
    {
      ...
      features: e ? [
        "100 Credits / month",
        "3× each feature (analyze / advisor / agent)",
        "Deep analysis: paid only",
        "Try all features",
      ] : j ? [
        "100 クレジット / 月",
        "各機能 3 回体験",
    ...
    {
      tier: "basic", label: "Basic", priceMonthly: 15, priceAnnual: 126,
      currency: "USDC", credits: 1350, rollover: 450, savingsAnnual: 54,
      features: e ? [
        "1,350 Credits / month",
        "Roll over up to 450 credits",
        "~150× AI conversations",
        "~9× AI deep analysis",
        "~168× Security scans",
    ...
    {
      tier: "pro", label: "Pro", priceMonthly: 30, priceAnnual: 252,
      currency: "USDC", credits: 3500, rollover: 1000, savingsAnnual: 108,
      features: e ? [
        "3,500 Credits / month",
        "Roll over up to 1,000 credits",
        "~388× AI conversations",
        "~23× AI deep analysis",
        "~437× Security scans",
...
function getCreditCosts(lang: Lang) {
  const e = lang === "en", j = lang === "ja";
  return [
    { icon: "🌿", label: e ? "AI Deep Analysis (Sonnet 4.6)" : j ? "AI 深度分析 (Sonnet 4.6)" : "AI 深度分析 (Sonnet 4.6)", cost: 150, feature: "advisor_deep" },
    { icon: "💬", label: e ? "AI Advisor (Sonnet 4.6)" : j ? "AI アドバイザー (Sonnet 4.6)" : "AI 顧問 (Sonnet 4.6)", cost: 9, feature: "advisor" },
    { icon: "🔰", label: e ? "Security Scan" : j ? "セキュリティ分析" : "安全分析", cost: 8, feature: "analyze" },
    { icon: "⚙️", label: e ? "Agent Execution" : j ? "Agent 実行" : "Agent 執行", cost: 8, feature: "agent" },
    { icon: "🌸", label: e ? "Portfolio Optimize" : j ? "ポートフォリオ最適化" : "組合優化", cost: 8, feature: "portfolio" },
    { icon: "⛩️", label: e ? "On-chain Verify" : j ? "オンチェーン検証" : "鏈上驗證", cost: 1, feature: "verify" },
  ];
}
